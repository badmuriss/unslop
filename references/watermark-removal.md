...
- `references/watermarks/mark-classes.md` — Unicode / sampling / C2PA / containers
- `references/watermarks/vendor-notes.md` — Claude, Gemini/SynthID, OpenAI, open-LLM
- `references/watermarks/removal-matrix.md` — which layer when
- `references/watermarks/ethics.md` — intended use
- `references/watermarks/how-claude-marks.md` — Anthropic-specific detail
